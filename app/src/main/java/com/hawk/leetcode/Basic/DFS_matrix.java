...
public class DFS_matrix extends BaseClass {
    ...
    public ArrayList<Node> findNeighbours(int adjacency_matrix[][], Node x) { // function is same with BFS_matrix.java
    ...
    // A. Recursive DFS
    public void dfs_ArrayList(int adjacency_matrix[][], Node node) {
    ...
    public void dfs_Stack(int adjacency_matrix[][], Node startNode) {
...
//                N0, N1, N2, N3, N4, N5, N6
        ...
        DFS_matrix dfsExample = new DFS_matrix();

        System.out.println("The DFS traversal of the graph using stack ");
        dfsExample.dfs_Stack(adjacency_matrix, node40); // B. Iterative DFS using stack
        ...
        dfsExample.dfs_ArrayList(adjacency_matrix, node40); // A. Recursive DFS
